# -*- coding: utf-8 -*-
#
# restapp documentation build configuration file, created by
...
# of the sidebar.
html_logo = 'restapp-logo-small.png'
...
latex_documents = [
  ('index', 'restapp.tex', u'restapp Documentation',
