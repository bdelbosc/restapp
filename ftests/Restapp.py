...
#
[test_restapp]
description=Simple restapp api test
...
log_path = log/restapp-test.log

# result_path = path to store the xml result file
result_path = log/restapp-test.xml
...
log_to = file
log_path = log/restapp-bench.log
result_path = log/restapp-bench.xml
#ok_codes =  200:301:302
sleep_time_min = 0
sleep_time_max = 2
